# -*- coding: utf-8 -*-
# developing a Cryptocurrency which will be used in smart grid system
import datetime
import hashlib
import json
...
def mine_block():
    ...
    blockchain.add_transaction(sender = node_address, reciever = 'Saransh', amount = 1)
...
def get_chain():
    ...
    return jsonify(response), 200
#verifying block is valid or not
...
def connect_node():
    ...
    response ={'message':'All the nodes are now connected.The Electrocoin Blockchain now contains following nodes',
